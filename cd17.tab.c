...
#line 12 "cd17.y"
          {printf("Result = %d\n", yyvsp[-1]);}
#line 1067 "cd17.tab.c"
    break;

  case 3: /* expr: expr '+' expr  */
#line 14 "cd17.y"
              {yyval = yyvsp[-2] + yyvsp[0];}
#line 1073 "cd17.tab.c"
    break;

  case 4: /* expr: expr '-' expr  */
#line 15 "cd17.y"
                {yyval = yyvsp[-2] - yyvsp[0];}
#line 1079 "cd17.tab.c"
    break;

  case 5: /* expr: expr '*' expr  */
#line 16 "cd17.y"
                {yyval = yyvsp[-2] * yyvsp[0];}
#line 1085 "cd17.tab.c"
    break;

  case 6: /* expr: expr '/' expr  */
#line 17 "cd17.y"
                {if (yyvsp[0] == 0){yyerror("Division by zero!!"); exit(1);} else {yyval = yyvsp[-2]/yyvsp[0];}}
#line 1091 "cd17.tab.c"
    break;

  case 7: /* expr: NUMBER  */
#line 18 "cd17.y"
         {yyval = yyvsp[0];}
#line 1097 "cd17.tab.c"
    break;


#line 1101 "cd17.tab.c"
